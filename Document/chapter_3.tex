...
\begin{doublespace}
	...
	This phase will involve resource persons from the UPV Computer Science and PE Departments. It focuses on developing the system’s design concept, including the integration of infrared sensors, LED light modules, and speakers to create multimodal stimuli, as well as the initial design of the software’s user interface. Consultations and brainstorming sessions will be carried out online or face-to-face. The goal of this phase is to conceptualize an efficient, portable, and user-friendly hardware–software system tailored to the specific training needs of racket sports.
...
\begin{doublespace}
	...
	In this phase, the researchers will be required to work closely with their adviser to guide the development of the prototype. It involves assembling the hardware components—such as infrared sensors, the microcontroller, LED indicators, and audio modules—and developing the accompanying application responsible for system control and data management. Because timing precision is essential in reaction-time measurement, this phase will also involve integrating ESP-NOW as the system’s wireless communication protocol.. The work will be conducted at the researchers’ personal workstations and in the CAS computer laboratories. The goal of this phase is to produce a functional prototype capable of reliably recording and analyzing athlete response data, thereby demonstrating the technical feasibility of the proposed system.
