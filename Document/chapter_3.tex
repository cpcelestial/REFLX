...
\begin{doublespace}
	...
	In this phase, the researchers will be required to work closely with their adviser to guide the development of the prototype. It involves assembling the hardware components—such as infrared sensors, the microcontroller, LED indicators, and audio modules—and developing the accompanying application responsible for system control and data management. During this stage, algorithms will be designed to accurately measure response latency and agility metrics. The work will be conducted at the researchers’ personal workstations and in the CAS computer laboratories. The goal of this phase is to produce a functional prototype capable of reliably recording and analyzing athlete response data, thereby demonstrating the technical feasibility of the proposed system.
